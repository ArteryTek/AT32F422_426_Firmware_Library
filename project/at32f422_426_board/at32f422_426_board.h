...
#ifndef __AT32F422_426_BOARD_H
#define __AT32F422_426_BOARD_H
...
/**
  ...
  * 1. at-start-f422 v1.x boards
  * 1. at-start-f426 v1.x boards
  * if define AT_START_F422_V1, the header file support at-start-f422 v1.x board
  * if define AT_START_F426_V1, the header file support at-start-f426 v1.x board
  */

#if !defined (AT_START_F422_V1) && !defined (AT_START_F426_V1)
#error "please select first the board at-start device used in your application (in at32f422_426_board.h file)"
#endif
