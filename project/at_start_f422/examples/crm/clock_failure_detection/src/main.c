...
/** @addtogroup 422_CRM_clock_failure_detection CRM_clock_failure_detection
  * @{
  */
...
/**
  * @brief  config sclk 180 mhz with hick clock source.
...
static void sclk_180m_hick_config(void)
{
  ...
  crm_pll_config(CRM_PLL_SOURCE_HICK, CRM_PLL_MULT_45);
