...
/** @addtogroup 422_TMR_external_clock TMR_external_clock
  * @{
  */
...
int main(void)
{
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_1, 90);
  /* tmr3 channel 1 */
