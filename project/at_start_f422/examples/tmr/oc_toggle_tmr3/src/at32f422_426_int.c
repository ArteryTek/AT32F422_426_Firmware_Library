...
/** @addtogroup 422_TMR_oc_toggle_tmr3
  * @{
  */
...
{
  /* TMR3_CH1 toggling with frequency = 305.18 Hz */
  ...
  /* TMR3_CH2 toggling with frequency = 610.35 Hz */
  ...
  /* TMR3_CH3 toggling with frequency = 1.22 KHz */
  ...
  /* TMR3_CH4 toggling with frequency = 2.44 KHz */
