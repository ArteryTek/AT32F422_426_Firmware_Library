...
/** @addtogroup 422_TMR_cascade_synchro TMR_cascade_synchro
  * @{
  */
...
int main(void)
{
   ...
   *  the timxclk is fixed to 180 mhz, the tmr1 counter clock is 180 mhz.
  ...
  */
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_1, 45);
