/**
  ...
  */
  ...
  pwm(freq = 703khz, period = 1.42us, duty = 50%), connect pa8 to cmp_input(pa1).
  and then observe the cmp_output(pa0) through oscilloscope, it should have a 
  similar frequency to pwm, but the duty cycle is only 25%. because 64 pclk(~0.35555us)
  have been filtered out.for more detailed information. please refer to the application 
  note document AN0266.
