...
/** @addtogroup 422_WWDT_reset WWDT_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 180000000 ) = 0.0116s = 11.6ms
   window  = 16 * (32768 / 180000000 ) = 0.0029s = 2.9ms
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (6ms > 2.9ms) */
    delay_ms(6);
