...
/** @addtogroup 422_ADC_exint_trigger_partitioned ADC_exint_trigger_partitioned
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_ordinary_conversion_trigger_set(ADC1, ADC_ORDINARY_TRIG_EXINT11, TRUE);
  ...
  adc_preempt_conversion_trigger_set(ADC1, ADC_PREEMPT_TRIG_EXINT15, TRUE);
