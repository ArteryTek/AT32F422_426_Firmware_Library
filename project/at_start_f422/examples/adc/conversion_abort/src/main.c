...
/** @addtogroup 422_ADC_conversion_abort ADC_conversion_abort
  * @{
  */
...
int main(void)
{
  ...
  while(1)
  {
    ...
    if((conversion_times_index == dma_trans_complete_flag) || (error_times_index != (adc1_overflow_flag + adc1_conversion_fail_flag)))
    {
