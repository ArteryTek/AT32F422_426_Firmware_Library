...
#ifndef __AT32F422_426_H
#define __AT32F422_426_H
...
#if defined (AT32F422KBT7) || defined (AT32F422K8T7)   || defined (AT32F422KBU7)   || \
    defined (AT32F422K8U7) || defined (AT32F422KBU7_4) || defined (AT32F422K8U7_4)

    #define AT32F422Kx
#endif

#if defined (AT32F422GBU7_4) || defined (AT32F422G8U7_4)

    #define AT32F422Gx
#endif

#if defined (AT32F422FBP7) || defined (AT32F422F8P7)
...
#if defined (AT32F426KBT7) || defined (AT32F426K8T7)   || defined (AT32F426KBU7)   || \
    defined (AT32F426K8U7) || defined (AT32F426KBU7_4) || defined (AT32F426K8U7_4)

    #define AT32F426Kx
#endif

#if defined (AT32F426GBU7_4) || defined (AT32F426G8U7_4)

    #define AT32F426Gx
#endif

#if defined (AT32F426FBP7) || defined (AT32F426F8P7)
...
/**
  * @brief at32f422_426 standard peripheral library version number
  */
...
#define __AT32F422_426_LIBRARY_VERSION          ((__AT32F422_426_LIBRARY_VERSION_MAJOR << 24)  | \
                                                 ...
                                                 (__AT32F422_426_LIBRARY_VERSION_MINOR << 8)   | \
                                                 (__AT32F422_426_LIBRARY_VERSION_RC))
...
/**
  * @brief at32f422_426 interrupt number definition, according to the selected device
...
typedef enum IRQn
{
    ...
    TMR4_GLOBAL_IRQn            = 19,     /*!< tmr4 global interrupt                                */
    ...
    CAN1_TX_IRQn                = 30,     /*!< can1 tx interrupt                                    */
    CAN1_RX_IRQn                = 31,     /*!< can1 rx interrupt                                    */
    I2C1_ERR_IRQn               = 32,     /*!< i2c1 error interrupt                                 */
    I2C2_ERR_IRQn               = 34,     /*!< i2c2 error interrupt                                 */
    CAN1_STAT_IRQn              = 35,     /*!< can1 stat interrupt                                  */
    CAN1_ERR_IRQn               = 36,     /*!< can1 err interrupt                                   */
    FPU_IRQn                    = 37      /*!< fpu interrupt                                        */
...
#define TMR4_BASE                        (APB1PERIPH_BASE + 0x2000)
