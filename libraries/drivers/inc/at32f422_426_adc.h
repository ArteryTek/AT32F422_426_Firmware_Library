/**
  **************************************************************************
  * @file     at32f422_426_adc.h
  * @brief    at32f422_426 adc header file
  **************************************************************************
...
#ifndef __AT32F422_426_ADC_H
#define __AT32F422_426_ADC_H
...
#define ADC_TCF_INT                      ((uint32_t)0x08000000) /*!< triger conversion fail interrupt */
...
#define ADC_VMOR_FLAG                    ((uint16_t)0x0001) /*!< voltage monitoring out of range flag */
#define ADC_CCE_FLAG                     ((uint16_t)0x0002) /*!< channels conversion end flag */
#define ADC_PCCE_FLAG                    ((uint16_t)0x0004) /*!< preempt channels conversion end flag */
#define ADC_PCCS_FLAG                    ((uint16_t)0x0008) /*!< preempt channel conversion start flag */
#define ADC_OCCS_FLAG                    ((uint16_t)0x0010) /*!< ordinary channel conversion start flag */
#define ADC_OCCO_FLAG                    ((uint16_t)0x0020) /*!< ordinary channel conversion overflow flag */
#define ADC_RDY_FLAG                     ((uint16_t)0x0040) /*!< adc ready to conversion flag */
#define ADC_TCF_FLAG                     ((uint16_t)0x0080) /*!< trigger convert fail flag */
#define ADC_OTCF_FLAG                    ((uint16_t)0x0100) /*!< ordinary trigger convert fail flag */
#define ADC_PTCF_FLAG                    ((uint16_t)0x0200) /*!< preempted trigger convert fail flag */
#define ADC_OSNF_NUMBER                  ((uint32_t)0xFFFFFFC3) /*!< ordinary convert fail sequence number all*/
#define ADC_PSNF_NUMBER                  ((uint32_t)0xFFFFFE7F) /*!< preempted convert fail sequence number all */
...
typedef enum
{
  ...
  ADC_ORDINARY_TRIG_TMR3CH3              = 0x03, /*!< timer3 ch3 event as trigger source of ordinary sequence */
  ADC_ORDINARY_TRIG_TMR3TRGOUT           = 0x04, /*!< timer3 trgout event as trigger source of ordinary sequence */
  ADC_ORDINARY_TRIG_TMR15CH1             = 0x05, /*!< timer15 ch1 event as trigger source of ordinary sequence */
  ADC_ORDINARY_TRIG_EXINT11              = 0x06, /*!< exint line11 event as trigger source of ordinary sequence */
  ADC_ORDINARY_TRIG_SOFTWARE             = 0x07  /*!< software(OCSWTRG) control bit as trigger source of ordinary sequence */
...
typedef enum
{
  ADC_PREEMPT_TRIG_TMR1TRGOUT            = 0x00, /*!< timer1 trgout event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_TMR1CH4               = 0x01, /*!< timer1 ch4 event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_TMR4CH4               = 0x02, /*!< timer4 ch4 event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_TMR15CH2              = 0x03, /*!< timer15 ch2 event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_TMR3CH4               = 0x04, /*!< timer3 ch4 event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_TMR15TRGOUT           = 0x05, /*!< timer15 trgout event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_EXINT15               = 0x06, /*!< exint line15 event as trigger source of preempt sequence */
  ADC_PREEMPT_TRIG_SOFTWARE              = 0x07  /*!< software(PCSWTRG) control bit as trigger source of preempt sequence */
...
/**
  * @brief adc xeoc sync type
  */
typedef enum
{
  ADC_XEOC_SYNC_RISING_EDGE              = 0x00, /*!< adc xeoc sync by rising edge */
  ADC_XEOC_SYNC_HIGH_LEVEL               = 0x01  /*!< adc xeoc sync by high level */
} adc_xeoc_sync_type;

/**
  * @brief adc fail auto processing mode type
  */
typedef enum
{
  ADC_AUTO_STORAGE_TEMPORARY_DATA        = 0x00, /*!< adc auto storage temporary data */
  ADC_AUTO_CONVERSION_FAIL_CHANNEL       = 0x01  /*!< adc auto conversion fail channel */
} adc_fail_auto_processing_mode_type;
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 2; /* [25:24] */
  ...
  */
  ...
  /**
  * @brief adc misc register, offset:0x70
  */
  union
  {
    __IO uint32_t misc1;
    struct
    {
      __IO uint32_t xeoc_sm              : 1; /* [0] */
      __IO uint32_t reserved1            : 3; /* [3:1] */
      __IO uint32_t tcfapen              : 1; /* [4] */
      __IO uint32_t reserved2            : 3; /* [7:5] */
      __IO uint32_t tcfaps               : 1; /* [8] */
      __IO uint32_t reserved3            : 23;/* [31:9] */
    } misc1_bit;
  };
  
  /**
  * @brief adc misc2 register, offset:0x74
  */
  union
  {
    __IO uint32_t misc2;
    struct
    {
      __IO uint32_t otcf                 : 1; /* [0] */
      __IO uint32_t ptcf                 : 1; /* [1] */
      __IO uint32_t osnf                 : 4; /* [5:2] */
      __IO uint32_t reserved1            : 1; /* [6] */
      __IO uint32_t psnf                 : 2; /* [8:7] */
...
flag_status adc_flag_get(adc_type *adc_x, uint16_t adc_flag);
flag_status adc_interrupt_flag_get(adc_type *adc_x, uint16_t adc_flag);
void adc_flag_clear(adc_type *adc_x, uint16_t adc_flag);
...
void adc_xeoc_sync_mode_set(adc_type *adc_x, adc_xeoc_sync_type xeoc_sync_mode);
void adc_fail_auto_processing_enale(adc_type *adc_x, confirm_state new_state);
void adc_fail_auto_processing_mode_set(adc_type *adc_x, adc_fail_auto_processing_mode_type fail_auto_processing_mode);
uint16_t adc_conversion_fail_sequence_number_get(adc_type *adc_x, uint32_t adc_group_number);
void adc_conversion_fail_sequence_number_clear(adc_type *adc_x, uint32_t adc_group_number);
