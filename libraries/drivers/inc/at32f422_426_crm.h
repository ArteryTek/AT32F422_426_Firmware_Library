/**
  **************************************************************************
  * @file     at32f422_426_crm.h
  * @brief    at32f422_426 crm header file
  **************************************************************************
...
#ifndef __AT32F422_426_CRM_H
#define __AT32F422_426_CRM_H
...
typedef enum
{
  ...
  CRM_TMR4_PERIPH_CLOCK                  = MAKE_VALUE(0x1C, 8),  /*!< tmr4 periph clock */
...
{
  /* ahb periph */
  CRM_DMA1_PERIPH_RESET                  = MAKE_VALUE(0x28, 0),  /*!< dma1 periph reset */
  CRM_CRC_PERIPH_RESET                   = MAKE_VALUE(0x28, 6),  /*!< crc periph reset */
  ...
  CRM_TMR4_PERIPH_RESET                  = MAKE_VALUE(0x10, 8),  /*!< tmr4 periph reset */
...
typedef enum
{
  ...
  CRM_ADC_DIV_3                          = 0x04, /*!< apb2clk div3 to adcclk */
  CRM_ADC_DIV_12                         = 0x05, /*!< apb2clk div12 to adcclk */
  CRM_ADC_DIV_5                          = 0x06, /*!< apb2clk div3 to adcclk */
...
typedef enum
{
  ...
  CRM_CLKOUT_HICK48                      = 0x05, /*!< output high speed internal clock to clkout pin */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved4            : 7; /* [21:15] */
  ...
  /**
    * @brief crm reserved3 register, offset:0x58~0x64
    */
  ...
  union
  {
    ...
    struct
    {
      __IO uint32_t ertc_pclksel         : 1; /* [0] */
      __IO uint32_t reserved1            : 23;/* [23:1] */
