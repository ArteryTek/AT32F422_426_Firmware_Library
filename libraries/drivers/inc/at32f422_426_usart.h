/**
  **************************************************************************
  * @file     at32f422_426_usart.h
  * @brief    at32f422_426 usart header file
  **************************************************************************
...
#ifndef __AT32F422_426_USART_H
#define __AT32F422_426_USART_H
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved3            : 9; /* [27:19] */
