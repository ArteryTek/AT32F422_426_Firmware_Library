/**
  **************************************************************************
  * @file     at32f422_426_cmp.h
  * @brief    at32f422_426 cmp header file
  **************************************************************************
...
#ifndef __AT32F422_426_CMP_H
#define __AT32F422_426_CMP_H
...
typedef enum
{
  ...
  CMP_OUTPUT_TMR4CH1                     = 0x04, /*!< comparator output connect to tmr4ch1 */
  CMP_OUTPUT_TMR4CHCLR                   = 0x05, /*!< comparator output connect to tmr4chclr */
...
typedef enum
{
  ...
  CMP_BLANKING_TMR4_CH4                  = 0x07  /*!< comparator selected tmr4 ch4 as blanking */
} cmp_blanking_type;
