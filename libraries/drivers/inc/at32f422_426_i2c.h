/**
  **************************************************************************
  * @file     at32f422_426_i2c.h
  * @brief    at32f422_426 i2c header file
  **************************************************************************
...
#ifndef __AT32F422_426_I2C_H
#define __AT32F422_426_I2C_H
...
typedef struct
{
  ...
  /**
    * @brief i2c dnf register, offset:0x24
    */
  union
  {
    __IO uint32_t dnf;
...
void i2c_digital_filter_value_set(i2c_type *i2c_x, uint8_t dfilters);
