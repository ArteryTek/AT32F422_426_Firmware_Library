/**
  **************************************************************************
  * @file     at32f422_426_flash.h
  * @brief    at32f422_426 flash header file
  **************************************************************************
...
#ifndef __AT32F422_426_FLASH_H
#define __AT32F422_426_FLASH_H
...
/** @defgroup FLASH_user_system_data0
  * @brief flash user system data0
  * @{
  */
...
#define USD_BOOT1_LOW                    ((uint16_t)0x0010) /*!< nboot1 = 1 */
#define USD_BOOT1_HIGH                   ((uint16_t)0x0000) /*!< nboot1 = 0 */
...
/** @defgroup FLASH_user_system_data1
  * @brief flash user system data1
  * @{
  */

#define USD_BOOT0_SW_DISABLE             ((uint16_t)0x0001) /*!< nboot0 sw disable, refer to pin */
#define USD_BOOT0_SW_ENABLE              ((uint16_t)0x0000) /*!< nboot0 sw enable, refer to bit  */

#define USD_BOOT0_LOW                    ((uint16_t)0x0002) /*!< nboot0 = 1 */
#define USD_BOOT0_HIGH                   ((uint16_t)0x0000) /*!< nboot0 = 0 */

#define USD_NRST_MODE_NRST               ((uint16_t)0x000C) /*!< nrst pin with nrst mode */
#define USD_NRST_MODE_GPIO               ((uint16_t)0x0008) /*!< nrst pin with gpio mode */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t boot0_sw             : 1; /* [10] */
      __IO uint32_t boot0                : 1; /* [11] */
      __IO uint32_t nrst_mode            : 2; /* [13:12] */
      __IO uint32_t reserved3            : 4; /* [17:14] */
      __IO uint32_t user_d0              : 8; /* [25:18] */
  ...
  /**
    * @brief flash fap_sts register, offset:0x24
    */
  union
  {
    __IO uint32_t fap_sts;
    struct
    {
      __IO uint32_t fap                  : 8; /* [7:0] */
      __IO uint32_t nfap                 : 8; /* [15:8] */
      __IO uint32_t reserved1            : 16; /* [31:16] */
    } fap_sts_bit;
  };
  
  /**
    * @brief flash reserved2 register, offset:0x70~0x28
    */
...
flash_status_type flash_ssb0_set(uint8_t usd_ssb0);
flash_status_type flash_ssb1_set(uint8_t usd_ssb1);
uint8_t flash_ssb0_status_get(void);
uint8_t flash_ssb1_status_get(void);
