/**
  **************************************************************************
  * @file     at32f422_426_tmr.h
  * @brief    at32f422_426 tmr header file
  **************************************************************************
...
#ifndef __AT32F422_426_TMR_H
#define __AT32F422_426_TMR_H
...
typedef enum
{
  ...
  TMR_SUB_ENCODER_MODE_D                 = 0x08, /*!< subordinate mode select encoder mode d */
  TMR_SUB_ENCODER_MODE_E                 = 0x09, /*!< subordinate mode select encoder mode e */
...
typedef enum
{
  ...
  TMR_ENCODER_MODE_D                     = TMR_SUB_ENCODER_MODE_D, /*!< tmr encoder mode d */
  TMR_ENCODER_MODE_E                     = TMR_SUB_ENCODER_MODE_E  /*!< tmr encoder mode e */ 
...
typedef enum
{
  TMR4_GPIO                             = 0x00, /*!< tmr4 input remap to gpio */
  TMR4_ERTCCLK                          = 0x01, /*!< tmr4 input remap to ertc clock */
  TMR4_HEXT_DIV32                       = 0x02, /*!< tmr4 input remap to hext div32*/
  TMR4_CLKOUT                           = 0x03  /*!< tmr4 input remap to clkout */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      __IO uint32_t tmr4_ch1_irmp         : 2; /* [1:0] */
