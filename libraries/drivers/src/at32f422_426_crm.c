...
/**
  ...
  *         - CRM_I2C1_PERIPH_RESET         - CRM_I2C2_PERIPH_RESET         - CRM_PWC_PERIPH_RESET         - CRM_CAN1_PERIPH_RESET
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  * @note   the maximum frequency of APB1/APB2 clock is 180 MHz
  * @param  value
  *         this parameter can be one of the following values:
  *         - CRM_APB1_DIV_1
  *         - CRM_APB1_DIV_2
