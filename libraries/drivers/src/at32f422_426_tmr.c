...
/**
  ...
  *         TMR1, TMR3, TMR4, TMR6, TMR15, TMR16, TMR17
  * @retval none
  */
...
/**
  ...
  * @param  tmr_x: select the tmr peripheral.
  *         this parameter can be one of the following values:
  *         TMR1, TMR3, TMR4, TMR15, TMR16, TMR17
  * @param  tmr_clock_div
  *         this parameter can be one of the following values:
  *         - TMR_CLOCK_DIV1
  *         - TMR_CLOCK_DIV2
...
/**
  ...
  * @param  tmr_channel
  *         this parameter can be one of the following values:
  *         - TMR_SELECT_CHANNEL_1   only available for TMR1, TMR3, TMR4, TMR15, TMR16, TMR17
  *         - TMR_SELECT_CHANNEL_2   only available for TMR1, TMR3, TMR4, TMR15
  *         - TMR_SELECT_CHANNEL_3   only available for TMR1, TMR3, TMR4
  *         - TMR_SELECT_CHANNEL_4   only available for TMR1, TMR3, TMR4
  * @param  tmr_output_struct
  *         - to the structure of tmr_output_config_type
  * @retval none
  */
...
/**
  ...
  *         this parameter can be one of the following values:
  *         - TMR_SELECT_CHANNEL_1    only available for TMR1, TMR3, TMR4, TMR15, TMR16, TMR17
  *         - TMR_SELECT_CHANNEL_1C   only available for TMR1, TMR15
  *         - TMR_SELECT_CHANNEL_2    only available for TMR1, TMR3, TMR4, TMR15
  *         - TMR_SELECT_CHANNEL_2C   only available for TMR1
  *         - TMR_SELECT_CHANNEL_3    only available for TMR1, TMR3, TMR4
  *         - TMR_SELECT_CHANNEL_3C   only available for TMR1
  *         - TMR_SELECT_CHANNEL_4    only available for TMR1, TMR3, TMR4
  *         - TMR_SELECT_CHANNEL_4C   only available for TMR1
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  *         - TMR_SUB_ENCODER_MODE_D
  *         - TMR_SUB_ENCODER_MODE_E
  *         - TMR_SUB_RESET_MODE
  *         - TMR_SUB_HANG_MODE
...
{
  if(encoder_mode == TMR_ENCODER_MODE_D || encoder_mode == TMR_ENCODER_MODE_E)
   tmr_x->stctrl_bit.smsel_3 = 0x1;
...
/**
  * @brief  set tmr input channel remap
  * @param  tmr_x: select the tmr peripheral.
  *         this parameter can be one of the following values:
  *         TMR4
  * @param  input_remap
...
{
    tmr_x->rmp_bit.tmr4_ch1_irmp = input_remap;
}
